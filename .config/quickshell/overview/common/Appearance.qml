...
Singleton {
    ...
    property QtObject defaultColors: QtObject {
        ...
        property color m3primary: "#bb86fc"
        property color m3onPrimary: "#0a0a14"
        property color m3primaryContainer: "#7c3aed"
        property color m3onPrimaryContainer: "#cdd6f4"
        property color m3secondary: "#cba6f7"
        property color m3onSecondary: "#0a0a14"
        property color m3secondaryContainer: "#4a1a6e"
        property color m3onSecondaryContainer: "#cdd6f4"
        property color m3background: "#0a0a14"
        property color m3onBackground: "#cdd6f4"
        property color m3surface: "#0a0a14"
        property color m3surfaceContainerLow: "#12121e"
        property color m3surfaceContainer: "#161624"
        property color m3surfaceContainerHigh: "#1e1e30"
        property color m3surfaceContainerHighest: "#26263c"
        property color m3onSurface: "#cdd6f4"
        property color m3surfaceVariant: "#3d3d6b"
        property color m3onSurfaceVariant: "#a6adc8"
        property color m3inverseSurface: "#cdd6f4"
        property color m3inverseOnSurface: "#0a0a14"
        property color m3outline: "#bb86fc"
        property color m3outlineVariant: "#3d3d6b"
        property color m3shadow: "#000000"
        property color m3tertiary: "#bb86fc"
        property color m3onTertiary: "#0a0a14"
        property color m3tertiaryContainer: "#6d28d9"
        property color m3onTertiaryContainer: "#cdd6f4"
        property color m3error: "#f38ba8"
        property color m3onError: "#0a0a14"
    }
